...
export function PlatePreregForm({ token, prereg }: PlatePreregFormProps) {
  ...
  return (
    <form
      ...
      className="flex flex-col gap-2.5 rounded-[var(--radius-frame)] border border-line-soft bg-surface-sunken p-4"
    >
      ...
      <SubmitButton pending={mutation.isPending} tone="ghost">
